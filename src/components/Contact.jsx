...
const Contact = () => {
    return (
        <div id="contact" className="container">
            <div className="row">
                <div className="col">
                    <h2 style={{ fontSize: '60px' }}>Let's work together!</h2>
                </div>
            </div>
            <div className="row justify-content-center contact-row">
                <div className="col-md-1">
                    <a className="nav-link icon-link" target="_blank" rel="noreferrer" href="https://github.com/innazh">
                ...
                <div className="col-md-1">
                    <a className="nav-link icon-link" target="_blank" rel="noreferrer" href="mailto:innazh1133@gmail.com">
                ...
                <div className="col-md-1">
                <a className="nav-link icon-link" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/inna-zhogova-47219014b/">
